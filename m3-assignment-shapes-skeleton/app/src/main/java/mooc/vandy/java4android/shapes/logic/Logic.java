...
public class Logic 
    ...
    /**
     * This method calculates area of a rectangle from the length
    ...
    /**
     * This method calculates perimeter of a rectangle.
     * @param length
     * @param width
    ...
    /**
     * This method calculates area of a circle from radius.
     * @param radius
    ...
    /**
     * This method calculates circumference of a circle.
     * @param radius
    ...
    /**
     * This method calculates area of a right angle triangle.
     * @param base
     * @param height
     * @return area of a right angle triangle
     */
    ...
    /**
     * This method calculates perimeter of a right angle triangle.
     * @param base
     * @param height
    ...
    public static double rightTrianglePerimeter(double base, double height) {
        ...
        // perimeter of a triangle is the sum of three sides of a triangle
        return base + height + hypotenus;
    }

    /**
     * This method calculates volume of a box.
     * @param length
     * @param width
     * @param depth
    ...
    /**
     * This method calculates the surface area of a box
     * @param length
     * @param width
     * @param depth
     * @return surface area of a box
     */
    public static double boxSurfaceArea(double length, double width, double depth) {
        // Surface area of a box is sum of all sides' area
        return 2 * (length * width) + 2 * (width * depth) + 2 * (length * depth);
    }

    /**
     * This method calculates volume of a sphere.
     * @param radius
    ...
    /**
     * This method calculates surface area of a sphere.
     * @param radius
